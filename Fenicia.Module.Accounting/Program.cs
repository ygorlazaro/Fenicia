...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<AccountingContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "AccountingConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/accounting"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "accounting"));
