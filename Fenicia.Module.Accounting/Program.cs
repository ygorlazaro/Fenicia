...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<AccountingContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString("AccountingConnection")?.Replace("{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments("/accounting"), appBuilder => appBuilder.UseModuleRequirement("accounting"));
