...
public class StockMovementRepository(BasicContext context)
    : BaseRepository<StockMovementModel>(context), IStockMovementRepository
{
    public async Task<List<StockMovementModel>> GetMovementAsync(
        Guid productId,
        DateTime startDate,
        DateTime endDate,
