...
public interface IProductService
{
    ...
    Task<List<GetAllDashboardProductForDataSourceResponse>>
    ...
    Task<ProductModel?> UpdateAsync(Guid id, ProductModel product, CancellationToken cancellationToken = default);
