...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PlusContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "PlusConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/plus"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "plus"));
