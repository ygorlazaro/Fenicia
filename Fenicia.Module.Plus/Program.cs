...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PlusContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString("PlusConnection")?.Replace("{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments("/plus"), appBuilder => appBuilder.UseModuleRequirement("plus"));
