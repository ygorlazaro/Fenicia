...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<HrContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString("HrConnection")?.Replace("{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments("/hr"), appBuilder => appBuilder.UseModuleRequirement("hr"));
