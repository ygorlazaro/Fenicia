...
public class ProjectAttachmentControllerTests
{
    ...
    public async Task GetByIdAsync_WhenItemExists_ReturnsOkWithItem()
    {
        ...
        // Act
        var result = await this.controller.GetByIdAsync(this.testProjectAttachmentId, ct);
    ...
    public async Task PatchAsync_WhenItemExists_ReturnsOkWithUpdatedItem()
    {
        ...
        // Act
        var result = await this.controller.PatchAsync(command, this.testProjectAttachmentId, ct);
    ...
    public async Task DeleteAsync_WhenItemExists_ReturnsNoContent()
    {
        ...
        // Act
        var result = await this.controller.DeleteAsync(this.testProjectAttachmentId, ct);
