...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        {
            app.MapOpenApi();
            app.MapScalarApiReference(x => { x.Authentication = new ScalarAuthenticationOptions { PreferredSecuritySchemes = ["Bearer "] }; });
        }

        app.UseAuthentication();
        app.UseAuthorization();

        app.UseWhen(o => o.Request.Path.StartsWithSegments("/ecommerce"), appBuilder => appBuilder.UseModuleRequirement("ecommerce"));
