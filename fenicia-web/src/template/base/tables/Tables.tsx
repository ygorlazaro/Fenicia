        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            Using the most basic table Fenicia, here&#39;s how <code>&lt;CTable&gt;</code>-based tables look in Fenicia.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">Use contextual classes to color tables, table rows or individual cells.</p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">
                            <a href="https://fenicia.gatoninja.com.br/docs/utilities/borders#border-color">Border color utilities</a> can be added to change colors:
                        </p>
                        <DocsExample href="components/table#bordered-tables">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">Border styles, active styles, and table variants are not inherited by nested tables.</p>
