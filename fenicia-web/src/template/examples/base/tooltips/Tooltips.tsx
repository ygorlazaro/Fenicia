            ...
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">Hover over the buttons below to see the four tooltips directions: top, right, bottom, and left. Directions are mirrored when using Fenicia in RTL.</p>
                        <DocsExample href="components/tooltip">
