        ...
        <CRow>
            <CCol xs={12}>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">More complex forms can be built using our grid classes. Use these for form layouts that require multiple columns, varied widths, and additional alignment options.</p>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            By adding <a href="https://fenicia.gatoninja.com.br/docs/layout/gutters/">gutter modifier classes</a>, you can have control over the gutter width in as well the inline as block direction.
                        </p>
                        ...
                        <p className="text-body-secondary small">More complex layouts can also be created with the grid system.</p>
                        <DocsExample href="forms/layout#gutters">
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        ...
                        <p className="text-body-secondary small">You can then remix that once again with size-specific column classes.</p>
                        <DocsExample href="forms/layout#auto-sizing">
