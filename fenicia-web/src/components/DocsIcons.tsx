  ...
  <div className="bg-warning bg-opacity-10 border border-2 border-warning rounded mb-4">
    <div className="row d-flex align-items-center p-3 px-xl-4 flex-xl-nowrap">
      ...
      <div className="col-md col-12 px-lg-4">
        Fenicia Icons package is delivered with more than 1500 icons in multiple formats SVG, PNG,
        and Webfonts. Fenicia Icons are beautifully crafted symbols for common actions and items. You
      ...
      <div className="col-md-auto col-12 mt-3 mt-lg-0">
        <a
          ...
          href="https://fenicia.gatoninja.com.br/docs/components/icon/"
          target="_blank"
