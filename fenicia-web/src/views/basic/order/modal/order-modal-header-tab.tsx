...
export default function OrderModalHeaderTab({ visible, onChange, value }: OrderModalHeaderTabProps) {
    ...
    return (<CTabPane visible={visible}>
        <CRow>
            <CCol md={6}>
                <FeniciaSelect
                    ...
                    data={customers}
                    onChange={(e) => handlerOrder('customerId', e.target.value)}
                    id="customer"
                    required
                />
            </CCol>
            <CCol md={6}>
                <FeniciaInput
                    ...
                    onChange={(e) => handlerOrder('saleDate', e.target.value)}
                    id="saleDate"
                    required
                />
            ...
            <CCol md={12}>
                <FeniciaSelect
                    ...
                    value={order.status}
                    data={status}
                    onChange={(e) => handlerOrder('status', e.target.value)}
                    id="status"
                    required
                />
            </CCol>
            <CCol md={12}>
                <FeniciaSelect
                    ...
                    data={employees}
                    onChange={(e) => handlerOrder('employeeId', e.target.value)}
                    id="employee"
                />
            </CCol>
        </CRow>
