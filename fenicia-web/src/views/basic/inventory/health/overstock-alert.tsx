    ...
    return (<CRow className="mb-4">
        <CCol xs={12}>
            <CCard>
                ...
                <CCardBody>
                    {data.products.length === 0 ? <p className="text-muted text-center">{t('inventory.noOverstock')}</p> : <CTable hover responsive>
                        <CTableHead>
                            <CTableRow>
                        ...
                        <CTableBody>
                            {data.products.map(product => <CTableRow key={product.productId}>
                                <CTableDataCell>
