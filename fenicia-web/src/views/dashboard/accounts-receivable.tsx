...
const AccountsReceivable = ({ data }: AccountsReceivableProps) => {
    ...
    return (
        <CCol md={4}>
            <CCard className="mb-4">
                ...
                <CCardBody>
                    {data?.totalPending === 0 && data?.totalApproved === 0 ? (
                            ...
                            >
                                <CCol xs={6}>
                                    <div className="text-center">
                                        <div className="text-warning fw-semibold">{formatCurrency(data?.totalPending)}</div>
                                ...
                                <CCol xs={6}>
                                    <div className="text-center">
                                        <div className="text-success fw-semibold">{formatCurrency(data?.totalApproved)}</div>
                                        <small className="text-body-secondary">
