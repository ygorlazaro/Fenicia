...
const SubscriptionHeader = ({ subscribedCount, selectedCountNew, modulesCount, subscribedModulesCount, handleSelectAll }: SubscriptionHeaderProps) => {
    return (
        <>
            <p className="text-muted mb-4">Selecione os módulos que deseja assinar para sua empresa.</p>
            ...
            <div className="alert alert-info mb-4 p-3">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <span className="badge bg-info">excluindo Básico</span>
                </div>
            </div>
