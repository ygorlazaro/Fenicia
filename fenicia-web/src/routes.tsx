...
const Suppliers = React.lazy(() => import("./template/basic/supplier"));
const ProductCategories = React.lazy(() => import("./template/basic/product-category"));
const Products = React.lazy(() => import("./template/basic/product"));
const Inventory = React.lazy(() => import("./template/basic/inventory"));
const StockMovement = React.lazy(() => import("./template/basic/stock-movement"));
const Orders = React.lazy(() => import("./template/basic/order"));
const OrderDetail = React.lazy(() => import("./template/basic/order-detail"));
...
const routes = [
  ...
  { path: '/basic/product-categories', name: 'Product Categories', element: ProductCategories },
