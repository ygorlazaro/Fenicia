...
const ProductCategories = React.lazy(
  () => import("./views/basic/product-category"),
);
...
const NotificationList = React.lazy(
  () => import("./views/auth/notifications/notification-list"),
);
const NotificationDetail = React.lazy(
  () => import("./views/auth/notifications/notification-detail"),
);
...
const ProjectSubtaskList = React.lazy(
  () => import("./template/project/subtask"),
);
const ProjectCommentList = React.lazy(
  () => import("./template/project/comment"),
);
const ProjectAttachmentList = React.lazy(
  () => import("./template/project/attachment"),
);
const ProjectTaskAssigneeList = React.lazy(
  () => import("./template/project/task-assignee"),
);
const Dashboard = React.lazy(() => import("./views/dashboard"));
const Colors = React.lazy(() => import("./template/theme/colors/Colors"));
const Typography = React.lazy(
  () => import("./template/theme/typography/Typography"),
);
const Orders = React.lazy(() => import("./views/basic/order"));

// Base
const Accordion = React.lazy(
  () => import("./template/base/accordion/Accordion"),
);
const Breadcrumbs = React.lazy(
  () => import("./template/base/breadcrumbs/Breadcrumbs"),
);
const Cards = React.lazy(() => import("./template/base/cards/Cards"));
const Carousels = React.lazy(
  () => import("./template/base/carousels/Carousels"),
);
const Collapses = React.lazy(
  () => import("./template/base/collapses/Collapses"),
);
const ListGroups = React.lazy(
  () => import("./template/base/list-groups/ListGroups"),
);
const Navs = React.lazy(() => import("./template/base/navs/Navs"));
const Paginations = React.lazy(
  () => import("./template/base/paginations/Paginations"),
);
const Placeholders = React.lazy(
  () => import("./template/base/placeholders/Placeholders"),
);
...
const ButtonGroups = React.lazy(
  () => import("./template/buttons/button-groups/ButtonGroups"),
);
const Dropdowns = React.lazy(
  () => import("./template/buttons/dropdowns/Dropdowns"),
);

//Forms
const ChecksRadios = React.lazy(
  () => import("./template/forms/checks-radios/ChecksRadios"),
);
const FloatingLabels = React.lazy(
  () => import("./template/forms/floating-labels/FloatingLabels"),
);
const FormControl = React.lazy(
  () => import("./template/forms/form-control/FormControl"),
);
const InputGroup = React.lazy(
  () => import("./template/forms/input-group/InputGroup"),
);
...
const Validation = React.lazy(
  () => import("./template/forms/validation/Validation"),
);
...
const CoreUIIcons = React.lazy(
  () => import("./template/icons/coreui-icons/CoreUIIcons"),
);
...
const Alerts = React.lazy(
  () => import("./template/notifications/alerts/Alerts"),
);
const Badges = React.lazy(
  () => import("./template/notifications/badges/Badges"),
);
const Modals = React.lazy(
  () => import("./template/notifications/modals/Modals"),
);
const Toasts = React.lazy(
  () => import("./template/notifications/toasts/Toasts"),
);
