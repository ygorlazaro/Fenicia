...
namespace Fenicia.Auth.Migrations;
    ...
    [Migration("20260903091009_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.BlockModel", b =>
                {
                    ...
                    b.HasIndex("BlockedUserId")
                        .HasDatabaseName("ix_blocks_blocked_user_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_blocks_user_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FriendshipModel", b =>
                {
                    ...
                    b.HasIndex("TargetUserId")
                        .HasDatabaseName("ix_friendships_target_user_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.BlockModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "BlockedUser")
                        .WithMany()
                        .HasForeignKey("BlockedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blocks_users_blocked_user_id");
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blocks_users_user_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FriendshipModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "TargetUser")
                        .WithMany()
                        .HasForeignKey("TargetUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friendships_users_target_user_id");
