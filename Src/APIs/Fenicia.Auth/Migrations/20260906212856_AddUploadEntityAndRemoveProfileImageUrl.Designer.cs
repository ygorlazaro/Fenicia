...
namespace Fenicia.Auth.Migrations
{
    ...
    [Migration("20260906212856_AddUploadEntityAndRemoveProfileImageUrl")]
    partial class AddUploadEntityAndRemoveProfileImageUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.AttachmentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectCommentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectStatusModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectSubtaskModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectTaskModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.SprintModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.TaskAssigneeModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.TeamModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.TeamUserModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("team_users", "project");
                });

            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.AttachmentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("attachments", "social_network");
                });
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.BlockModel", b =>
                {
                    ...
                    b.HasIndex("BlockedProfileId")
                        .HasDatabaseName("ix_blocks_blocked_profile_id");

                    b.HasIndex("ProfileId")
                        .HasDatabaseName("ix_blocks_profile_id");

                    b.ToTable("blocks", "social_network");
                });

            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.CommentModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_comments1");

                    b.HasIndex("FeedId")
                        .HasDatabaseName("ix_comments_feed_id");
                    ...
                    b.ToTable("comments", "social_network");
                });
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FeedModel", b =>
                {
                    ...
                    b.Property<Guid?>("OriginalFeedId")
                        .HasColumnType("uuid")
                        .HasColumnName("original_feed_id");
                    ...
                    b.HasIndex("OriginalFeedId")
                        .HasDatabaseName("ix_feeds_original_feed_id");

                    b.HasIndex("ProfileId")
                        .HasDatabaseName("ix_feeds_profile_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FriendshipModel", b =>
                {
                    ...
                    b.HasIndex("ProfileId")
                        .HasDatabaseName("ix_friendships_profile_id");

                    b.HasIndex("TargetProfileId")
                        .HasDatabaseName("ix_friendships_target_profile_id");

                    b.ToTable("friendships", "social_network");
                });
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.ReportModel", b =>
                {
                    ...
                    b.ToTable("reports", "social_network");
                });

            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.ShareModel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("OriginalFeedId")
                        .HasDatabaseName("ix_shares_original_feed_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.AttachmentModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Project.ProjectTaskModel", "TaskModel")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectStatusModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Project.ProjectModel", "ProjectModel")
                        .WithMany("Statuses")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.ProjectTaskModel", b =>
                {
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.Project.SprintModel", "SprintModel")
                        .WithMany("Tasks")
                        .HasForeignKey("SprintId")
                        .HasConstraintName("fk_tasks_sprints_sprint_id");

                    b.HasOne("Fenicia.Common.Data.Models.Project.ProjectStatusModel", "StatusModel")
                        .WithMany("Tasks")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.SprintModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_sprints_users_created_by");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.TeamModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "Creator")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.Project.ProjectModel", "Project")
                        .WithMany("Teams")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.Project.TeamUserModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Project.TeamModel", "Team")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.BlockModel", b =>
                {
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.ProfileModel", "Profile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_blocks_profiles_profile_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.CommentModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.FeedModel", "Feed")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_comments_feeds_feed_id");

                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.CommentModel", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FeedModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.FeedModel", "OriginalFeed")
                        .WithMany()
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.ProfileModel", "Profile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_feeds_profiles_profile_id");

                    b.Navigation("OriginalFeed");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.FriendshipModel", b =>
                {
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.ProfileModel", "TargetProfile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_friendships_profiles_target_profile_id");
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.ReportModel", b =>
                {
                    b.HasOne("Fenicia.Common.Data.Models.Auth.UserModel", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("Fenicia.Common.Data.Models.SocialNetwork.ShareModel", b =>
                {
                    ...
                    b.HasOne("Fenicia.Common.Data.Models.SocialNetwork.ProfileModel", "Profile")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shares_profiles_profile_id");
