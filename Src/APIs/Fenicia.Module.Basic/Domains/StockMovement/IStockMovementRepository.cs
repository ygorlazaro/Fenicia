...
{
    Task<IEnumerable<StockMovementModel>> GetByDateRangeAsync(
        DateTime startDate,
        DateTime endDate,
    ...
    Task<IEnumerable<StockMovementModel>> GetWithDetailsAsync(
        DateTime startDate,
        DateTime endDate,
        int page = 1,
        int pageSize = 10,
    ...
    Task<IEnumerable<StockMovementModel>> GetWithDetailsForDashboardAsync(
        DateTime startDate,
        DateTime endDate,
        CancellationToken cancellationToken = default);
