...
public class Program
{
    ...
    {
        var tenantArg = args.FirstOrDefault(o => o.StartsWith("--tenant=", StringComparison.Ordinal));
        ...
        if (app.Environment.IsDevelopment())
        {
            ...
            {
                x.Authentication = new ScalarAuthenticationOptions { PreferredSecuritySchemes = ["Bearer "] };
            });
        }
        ...
        app.UseWhen(
            o => o.Request.Path.StartsWithSegments("/customersupport"),
