...
{
    Task<List<GetAllProjectTaskAssigneeResponse>> GetAllAsync(
        GetAllProjectTaskAssigneeQuery query,
        CancellationToken cancellationToken = default);

    Task<GetProjectTaskAssigneeByIdResponse?> GetByIdAsync(
        GetProjectTaskAssigneeByIdQuery query,
        CancellationToken cancellationToken = default);

    Task<AddProjectTaskAssigneeResponse> AddAsync(
        AddProjectTaskAssigneeCommand command,
        Guid companyId,
        CancellationToken cancellationToken = default);

    Task<UpdateProjectTaskAssigneeResponse?> UpdateAsync(
