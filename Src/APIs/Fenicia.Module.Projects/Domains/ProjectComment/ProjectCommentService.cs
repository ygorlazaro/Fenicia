...
{
    public async Task<List<GetAllProjectCommentResponse>> GetAllAsync(
    ...
    public async Task<GetProjectCommentByIdResponse?> GetByIdAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            null => null,
            _ => new GetProjectCommentByIdResponse(
                projectComment.Id,
    ...
    public async Task<AddProjectCommentResponse> AddAsync(
    ...
    public async Task<UpdateProjectCommentResponse?> UpdateAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return updated is null
            ? null
            : new UpdateProjectCommentResponse(
                updated.Id,
                updated.TaskId,
                updated.UserId,
                updated.Content,
