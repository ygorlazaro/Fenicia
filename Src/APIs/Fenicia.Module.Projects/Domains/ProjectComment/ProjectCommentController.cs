...
public class ProjectCommentController(ProjectCommentService projectCommentService) : ControllerBase
{
    ...
    public async Task<ActionResult<List<GetAllProjectCommentResponse>>> GetAsync(WideEventContext wide, [FromQuery] int page = 1, [FromQuery] int perPage = 10, CancellationToken ct)
    {
