...
public class FeedController(FeedService feedService) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="command">
    ///     The feed data to create. Example:
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "date": "2024-01-15T00:00:00Z", "text": "Hello world", "userId":
    ...
    /// </summary>
    /// <param name="command">
    ///     The feed data to update. Example:
    ///     <c>{ "id": "11111111-1111-1111-1111-111111111111", "date": "2024-01-15T00:00:00Z", "text": "Updated text" }</c>
    /// </param>
    /// <param name="id">
    ///     The unique identifier of the feed to update. Example: <c>11111111-1111-1111-1111-111111111111</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
    ...
    /// </summary>
    /// <param name="id">
    ///     The unique identifier of the feed to delete. Example: <c>11111111-1111-1111-1111-111111111111</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
