...
public class FeedController(FeedService feedService) : ControllerBase
{
    ...
    public async Task<ActionResult<List<GetAllFeedResponse>>> GetAsync(WideEventContext wide, [FromQuery] int page = 1, [FromQuery] int perPage = 10, CancellationToken ct = default)
    {
