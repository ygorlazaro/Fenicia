...
public class CommentController(CommentService commentService) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="command">
    ///     The comment data to create. Example:
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "userId": "22222222-2222-2222-2222-222222222222", "feedId":
    ///         "33333333-3333-3333-3333-333333333333", "parentCommentId": null, "text": "Great post!" }
    ///     </c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ...
    /// </summary>
    /// <param name="command">
    ///     The comment data to update. Example:
    ///     <c>{ "id": "11111111-1111-1111-1111-111111111111", "text": "Updated comment text" }</c>
    /// </param>
    /// <param name="id">
    ///     The unique identifier of the comment to update. Example: <c>11111111-1111-1111-1111-111111111111</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
    ...
    /// </summary>
    /// <param name="id">
    ///     The unique identifier of the comment to delete. Example: <c>11111111-1111-1111-1111-111111111111</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
    ...
    ///     The unique identifier of the parent comment. Example:
