...
public class ReportController(ReportService reportService) : ControllerBase
{
    ...
    /// </summary>
    /// <param name="id">
    ///     The unique identifier of the report to update. Example: <c>11111111-1111-1111-1111-111111111111</c>
    /// </param>
    /// <param name="command">
    ///     The new status. Example:
    ///     <c>{ "id": "11111111-1111-1111-1111-111111111111", "status": "Approved" }</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
    ...
    /// <response code="200">
    ///     Report status updated successfully. Example:
    ///     <c>{ "id": "11111111-1111-1111-1111-111111111111", "status": "Approved" }</c>
    /// </response>
