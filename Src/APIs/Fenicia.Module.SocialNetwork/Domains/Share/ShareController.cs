...
public class ShareController(ShareService shareService) : ControllerBase
{
    ...
    ///     Share data. Example:
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "originalFeedId": "22222222-2222-2222-2222-222222222222",
    ///         "text": "Check this out!" }
    ///     </c>
    /// </param>
    /// <param name="wide">
    ...
    /// <response code="201">
    ///     Share created successfully. Example:
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "originalFeedId": "22222222-2222-2222-2222-222222222222",
    ///         "text": "Check this out!", "companyId": "33333333-3333-3333-3333-333333333333", "userId":
    ///         "11111111-1111-1111-1111-111111111111", "shareDate": "2024-01-15T00:00:00Z" }
    ///     </c>
    /// </response>
    ...
    /// <response code="200">
    ///     Shares retrieved successfully. Example:
    ///     <c>
    ///         [{ "id": "11111111-1111-1111-1111-111111111111", "originalFeedId": "22222222-2222-2222-2222-222222222222",
    ///         "text": "Check this out!", "companyId": "33333333-3333-3333-3333-333333333333", "userId":
    ///         "11111111-1111-1111-1111-111111111111", "shareDate": "2024-01-15T00:00:00Z" }]
