...
import { CRow, CCol, CCard, CCardBody, CCardHeader, CTab, CTabContent, CTabList, CTabPanel, CTabs } from "@coreui/react";
        ...
        <CRow>
                ...
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            The basic React tabs example uses the <code>variant=&#34;tabs&#34;</code> props to generate a tabbed interface.
                        </p>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">
                            If you don’t provide the <code>variant</code> prop, the component will default to a basic style.
                        </p>
