...
export function FeniciaInput({ onChange, value, label, id, name, required, type = "text", onBlur, placeholder, maxLength, minLength, min = null, step = null, disabled = false }: FeniciaInputProps) {
