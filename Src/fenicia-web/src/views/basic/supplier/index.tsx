...
const Suppliers = () => {
    ...
    return (
        <CContainer className="py-4">
                                            ...
                                            {suppliers.map((supplier) => (
                                                <CTableRow key={supplier.id}>
                                                    ...
                                                    <CTableDataCell className="text-end">
                                                        <CButton color="info" size="sm" className="me-2" onClick={() => handleOpenEdit(supplier)}>
                                                            <CIcon icon={cilPencil} />
                                                        </CButton>
                                                        <CButton color="danger" size="sm" onClick={() => handleOpenDelete(supplier)}>
                                                            <CIcon icon={cilTrash} />
                                                        </CButton>
                                                    </CTableDataCell>
                                                </CTableRow>
            ...
            <SupplierModal visible={modalVisible} onClose={() => setModalVisible(false)} onSave={handleSave} supplier={selectedSupplier} loading={saving} />
            ...
            <CModal visible={deleteModalVisible} onClose={() => setDeleteModalVisible(false)}>
                ...
                <CModalBody>
                    <p>{t("suppliers.deleteConfirm", { name: supplierToDelete?.name })}</p>
                    <p className="text-danger">{t("suppliers.deleteWarning")}</p>
                </CModalBody>
                <CModalFooter>
