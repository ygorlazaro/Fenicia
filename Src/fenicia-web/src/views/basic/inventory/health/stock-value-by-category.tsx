                                ...
                                {data.map((category) => (
                                    <CListGroupItem key={category.categoryId} className="d-flex justify-content-between align-items-center">
                                        ...
                                        <div className="text-end">
                                            <div className="text-success fw-semibold">{formatCurrency(category.totalStockValue)}</div>
                                            <small className="text-body-secondary">{formatPercentage(category.percentage)}</small>
                                        </div>
                                    </CListGroupItem>
                                ))}
                            </CListGroup>
