...
import { CButton, CForm, CFormInput, CFormLabel, CFormSelect, CFormTextarea, CModal, CModalBody, CModalFooter, CModalHeader, CModalTitle, CAlert } from "@coreui/react";

const ProjectTaskModal = ({ visible, onClose, onSave, projectTask, loading }) => {
    ...
    return (
        <CModal visible={visible} onClose={onClose} size="lg">
            <CModalHeader>
                <CModalTitle>{projectTask ? "Editar Tarefa do Projeto" : "Nova Tarefa do Projeto"}</CModalTitle>
            </CModalHeader>
                ...
                <CModalBody>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <CFormSelect id="priority" name="priority" value={formData.priority} onChange={handleInputChange}>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <CFormInput type="number" id="estimatePoints" name="estimatePoints" value={formData.estimatePoints} onChange={handleInputChange} min="0" />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <CFormInput type="date" id="dueDate" name="dueDate" value={formData.dueDate} onChange={handleInputChange} />
                        </div>

                        <div className="col-md-6 mb-3">
                            <CFormLabel htmlFor="projectId">ID do Projeto</CFormLabel>
                            <CFormInput type="text" id="projectId" name="projectId" value={formData.projectId} onChange={handleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <CFormInput type="text" id="statusId" name="statusId" value={formData.statusId} onChange={handleInputChange} />
                        </div>

                        <div className="col-md-6 mb-3">
                            <CFormLabel htmlFor="createdBy">Criado Por</CFormLabel>
                            <CFormInput type="text" id="createdBy" name="createdBy" value={formData.createdBy} onChange={handleInputChange} />
                        </div>
                    </div>
                </CModalBody>
                <CModalFooter>
