        ...
        <CRow>
            ...
            <CCol xs={12}>
                <CCard className="mb-4">
                    ...
                    <CCardBody>
                        <p className="text-body-secondary small">Four options are available: top, right, bottom, and left aligned. Directions are mirrored when using Fenicia for React in RTL.</p>
