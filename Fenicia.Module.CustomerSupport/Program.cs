namespace Fenicia.Module.CustomerSupport;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<CustomerSupportContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "CustomerSupportConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/customersupport"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "customersupport"));
