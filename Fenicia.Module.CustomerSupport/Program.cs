...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<CustomerSupportContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString("CustomerSupportConnection")?.Replace("{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments("/customersupport"), appBuilder => appBuilder.UseModuleRequirement("customersupport"));
