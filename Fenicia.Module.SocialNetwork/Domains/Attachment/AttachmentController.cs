...
public class AttachmentController(IAttachmentService attachmentService, ICompanyContext companyContext) : ControllerBase
{
    /// <summary>
    ...
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "url": "https://example.com/file.pdf", "fileType": "pdf",
    ///         "fileSize": 1024, "commentId": "22222222-2222-2222-2222-222222222222" }
    ///     </c>
    /// </param>
    /// <param name="wide">
    ...
    /// <response code="201">
    ///     Attachment created successfully. Example:
    ///     <c>
    ///         { "id": "11111111-1111-1111-1111-111111111111", "url": "https://example.com/file.pdf", "fileType": "pdf",
    ///         "fileSize": 1024, "commentId": "22222222-2222-2222-2222-222222222222", "companyId":
    ///         "33333333-3333-3333-3333-333333333333", "uploadDate": "2024-01-15T00:00:00Z" }
    ///     </c>
    /// </response>
    ...
    /// </summary>
    /// <param name="id">
    ///     The unique identifier of the attachment to delete. Example:
    ...
    ///     The unique identifier of the comment. Example: <c>22222222-2222-2222-2222-222222222222</c>
    /// </param>
    /// <param name="wide">
    ///     Wide event context for audit logging. Example:
    ///     <c>{ "userId": "11111111-1111-1111-1111-111111111111" }</c>
    ...
    /// <response code="200">
    ///     Attachments retrieved successfully. Example:
    ///     <c>
    ///         [{ "id": "11111111-1111-1111-1111-111111111111", "url": "https://example.com/file.pdf", "fileType": "pdf",
    ///         "fileSize": 1024, "commentId": "22222222-2222-2222-2222-222222222222", "uploadDate": "2024-01-15T00:00:00Z" }]
    ///     </c>
    /// </response>
