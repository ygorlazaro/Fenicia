...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<SocialNetworkContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "SocialNetworkConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/socialnetwork"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "socialnetwork"));
