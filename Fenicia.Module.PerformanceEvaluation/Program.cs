...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PerformanceEvaluationContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "PerformanceEvaluationConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/performanceevaluation"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "performanceevaluation"));
