...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PerformanceEvaluationContext>((sp, o) =>
        {
            ...
            var connString = config.GetConnectionString("PerformanceEvaluation")?.Replace("{tenant}", tenantId);
