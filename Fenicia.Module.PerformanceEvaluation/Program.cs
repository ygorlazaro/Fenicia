...
using Fenicia.Module.PerformanceEvaluation.Contexts;
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PerformanceEvaluationContext>(
            (sp, options) =>
            {
                ...
                var connString = config
                    .GetConnectionString("PerformanceEvaluationConnection")
        ...
        app.UseWhen(
            context => context.Request.Path.StartsWithSegments("/performanceevaluation"),
