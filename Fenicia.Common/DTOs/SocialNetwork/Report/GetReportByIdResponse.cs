...
public class GetReportByIdResponse()
{
    ...
    public GetReportByIdResponse(Guid Id, Guid ReporterId, Guid TargetId, string TargetType, string Reason, string? Description, string Status, DateTime ReportDate)
        : this()
    {
        this.Id = Id;
