...
public class FeedRepositoryTests : IDisposable
{
    ...
    {
        // Arrange
        var feed1 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow.AddDays(-2), Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid() };
        var feed2 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow.AddDays(-1), Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid() };
        var feed3 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow, Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid() };
