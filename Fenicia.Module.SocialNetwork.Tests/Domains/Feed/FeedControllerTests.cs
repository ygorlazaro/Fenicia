...
public class FeedControllerTests : IDisposable
{
    ...
    public FeedControllerTests()
    {
        ...
        _controller = new FeedController(service, companyContext, profileService.Object) { ControllerContext = new ControllerContext { HttpContext = _mockHttpContext.Object } };
    ...
    {
        // Arrange
        var command = new AddFeedCommand(Guid.NewGuid(), DateTime.UtcNow, _faker.Lorem.Sentence(), _testUserId, Guid.NewGuid());
        var wide = new WideEventContext();
