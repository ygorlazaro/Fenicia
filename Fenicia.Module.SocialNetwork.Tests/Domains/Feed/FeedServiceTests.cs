...
public class FeedServiceTests : IDisposable
{
    ...
    {
        // Arrange
        var feed1 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow.AddDays(-2), Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid(), CompanyId = _companyId };
        var feed2 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow.AddDays(-1), Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid(), CompanyId = _companyId };
        var feed3 = new FeedModel { Id = Guid.NewGuid(), Date = DateTime.UtcNow, Text = _faker.Lorem.Sentence(), ProfileId = Guid.NewGuid(), CompanyId = _companyId };
    ...
    {
        // Arrange
        var command = new AddFeedCommand(Guid.NewGuid(), DateTime.UtcNow, _faker.Lorem.Sentence(), Guid.NewGuid(), Guid.NewGuid());
