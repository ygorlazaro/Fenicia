...
public class LikeControllerTests : IDisposable
{
    ...
    public LikeControllerTests()
    {
        ...
        var service = new LikeService(repository, feedRepository.Object);
        var profileService = new Mock<ProfileService>();
        _mockHttpContext = new Mock<HttpContext>();
        _controller = new LikeController(service, companyContext, profileService.Object) { ControllerContext = new ControllerContext { HttpContext = _mockHttpContext.Object } };
    ...
    public async Task GetLikesByFeedAsync_WhenLikesExist_ReturnsOkWithLikes()
    {
        ...
        // Act
        var result = await _controller.GetLikesByFeedAsync(feedId, wide, 1, 10, null, null, CancellationToken.None);
