...
public class CommentControllerTests : IDisposable
{
    ...
    public CommentControllerTests()
    {
        ...
        var service = new CommentService(repository, feedRepository.Object);
        var profileService = new Mock<ProfileService>();
        _mockHttpContext = new Mock<HttpContext>();
        _controller = new CommentController(service, companyContext, profileService.Object) { ControllerContext = new ControllerContext { HttpContext = _mockHttpContext.Object } };
