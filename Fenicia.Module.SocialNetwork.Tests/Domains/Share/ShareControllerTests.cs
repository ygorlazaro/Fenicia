...
public class ShareControllerTests : IDisposable
{
    ...
    public ShareControllerTests()
    {
        ...
        var service = new ShareService(repository, feedRepository.Object);
        var profileService = new Mock<ProfileService>();
        _mockHttpContext = new Mock<HttpContext>();
        _controller = new ShareController(service, companyContext, profileService.Object) { ControllerContext = new ControllerContext { HttpContext = _mockHttpContext.Object } };
