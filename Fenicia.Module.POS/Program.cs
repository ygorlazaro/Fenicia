...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<PosContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "PosConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/pos"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "pos"));
