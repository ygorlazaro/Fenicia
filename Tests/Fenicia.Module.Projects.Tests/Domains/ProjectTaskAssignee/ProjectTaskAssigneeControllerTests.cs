...
public class ProjectTaskAssigneeControllerTests
{
    ...
    public async Task GetAsync_WhenAssigneesExist_ReturnsOkWithAssignees()
    {
        ...
        _mockService
            .Setup(s => s.GetAllAsync(It.IsAny<GetAllProjectTaskAssigneeQuery>(), It.IsAny<CancellationToken>()))
    ...
    {
        var wide = new WideEventContext();
        var assignee = new GetProjectTaskAssigneeByIdResponse(
            Guid.NewGuid(),
            Guid.NewGuid(),
            Guid.NewGuid(),
            "Owner",
        ...
        _mockService.Setup(s => s.GetByIdAsync(
                It.IsAny<GetProjectTaskAssigneeByIdQuery>(),
    ...
    public async Task PostAsync_WhenCommandIsValid_ReturnsCreated()
    {
        ...
        var command = new AddProjectTaskAssigneeCommand(
            ...
            "Owner",
            DateTime.UtcNow);
        var response = new AddProjectTaskAssigneeResponse(
            command.Id,
            command.TaskId,
            command.UserId,
            command.Role,
    ...
    public async Task PatchAsync_WhenAssigneeExists_ReturnsOk()
    {
        ...
        var command = new UpdateProjectTaskAssigneeCommand(
            ...
            "Contributor",
            DateTime.UtcNow);
        var response = new UpdateProjectTaskAssigneeResponse(
            command.Id,
            command.TaskId,
            command.UserId,
            command.Role,
    ...
    public async Task DeleteAsync_WhenCalled_ReturnsNoContent()
    {
        ...
        _mockService.Setup(s => s.DeleteAsync(
                It.IsAny<DeleteProjectTaskAssigneeCommand>(),
                It.IsAny<CancellationToken>()))
