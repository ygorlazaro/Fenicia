...
public class InventoryControllerTests : IDisposable
{
    ...
    public async Task GetInventoryDashboardAsync_ReturnsOk()
    {
        ...
        // Act
        var result = await _controller.GetInventoryDashboardAsync(wide, 90, CancellationToken.None);
    ...
    public async Task GetInventoryAsync_ReturnsOk()
    {
        ...
        // Act
        var result = await _controller.GetInventoryAsync(wide, 1, 10, null, null, null, CancellationToken.None);
