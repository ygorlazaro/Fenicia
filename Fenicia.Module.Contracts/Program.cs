...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        builder.Services.AddDbContext<ContractsContext>((sp, options) =>
        {
            ...
            var connString = config.GetConnectionString(name: "ContractsConnection")?.Replace(oldValue: "{tenant}", tenantId);
        ...
        app.UseWhen(context => context.Request.Path.StartsWithSegments(other: "/contract"), appBuilder => appBuilder.UseModuleRequirement(moduleName: "contract"));
