...
public class GetInventoryByCategoryServiceTests : IDisposable
{
    ...
    [Fact]
    public async Task GetByCategoryAsync_WhenCategoryHasProducts_ReturnsInventory()
    {
        ...
        var result = await service.GetByCategoryAsync(new GetInventoryByCategoryQuery(category.Id), CancellationToken.None);
