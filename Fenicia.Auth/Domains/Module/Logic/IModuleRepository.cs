...
public interface IModuleRepository
{
    ...
    Task<List<ModuleModel>> GetAllOrderedAsync(CancellationToken cancellationToken, [Range(1, int.MaxValue)] int page = 1,
        [Range(1, 100)] int perPage = 10);
    ...
    Task<List<ModuleModel>> GetManyOrdersAsync([Required] IEnumerable<Guid> request,
