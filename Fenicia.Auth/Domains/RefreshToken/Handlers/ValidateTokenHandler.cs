...
public class ValidateTokenHandler(IConnectionMultiplexer redis) : IRequestHandler<ValidateTokenQuery, bool>
{
    ...
    public Task<bool> Handle(ValidateTokenQuery request, CancellationToken ct)
    {
